...
toast.error("Employee data not found. Please log in again.");
return;
}
...
const fetchLeaveRequests = async (employee_id) => {
  try {
    ...
    setLeaveRequests(res.data || []); // ✅ updated here
  } catch (err) {
...
try {
  ...
  setFormData({ leave_type: "", start_date: "", end_date: "", reason: "", no_of_leaves: "" });
...
return ( <div className="min-h-screen bg-gray-50 p-8"> <Card className="max-w-3xl mx-auto shadow-md border"> <CardHeader> <CardTitle className="text-[#001F7A] text-2xl font-bold">Apply for Leave</CardTitle> </CardHeader>
