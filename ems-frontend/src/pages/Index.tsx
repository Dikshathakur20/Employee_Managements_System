...
return ( <div className="min-h-screen bg-background transition-colors duration-500"> <div className="container mx-auto px-4 py-20">
{/* Hero Section */} <div className="text-center mb-20">
<div
...
> <Building className="w-10 h-10 text-primary-foreground" /> </div> <h1 className="text-5xl md:text-6xl font-extrabold mb-6 text-foreground">
Employee Management System </h1> <p className="text-xl md:text-2xl text-foreground/80 mb-10 max-w-3xl mx-auto leading-relaxed">
Comprehensive admin dashboard for managing employees, departments,
and designations with powerful CRUD operations. </p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl mx-auto">
      ...
      <Card
        ...
        style={{ animationDelay: "0.1s", background: "linear-gradient(-45deg, #ffffff, #c9d0fb)" }}
      >
        <CardHeader>
